...
export type TniJsonDeviceOutletId = TniJsonId;
export type TniJsonLocationId = TniJsonId;
export type TniJsonLocationPieceId = TniJsonId;

export type TniJsonLinkType = "copper"|"fiber";

type integer = number;

export const SPEC_FORMAT_VERSION = 9;
...
export interface TniJsonData {
	...
	device_outlets: Record<TniJsonDeviceOutletId, TniJsonDeviceOutlet>,
	locations: Record<TniJsonLocationId, TniJsonLocation>,
	location_pieces: Record<TniJsonLocationPieceId, TniJsonLocationPiece>,
}
...
export interface TniJsonLinkSizing {
	title: string,
	link_installed_bw: integer,
	costing: TniJsonLinkSizingCosting,
}
export interface TniJsonLinkSizingCosting {
	setup_fixed: integer,
	setup_per_floor: integer,
	setup_per_distance_samefloor: number,
	daily_fixed: integer,
	daily_per_floor: integer,
	daily_per_distance_samefloor: number,
}

export interface TniJsonDeviceOutlet {
	outlet_name: string,
	device_hardware_class: TniDeviceHardwareClass,
	logic_controller: TniJsonDeviceLogicController,
}

export interface TniJsonLocation {
	display_name: string,
	builder_weight: integer,
	spawn_limit: integer,
	will_not_spawn_before_day: integer,
	location_prerequisite_scn: string,
	description: string,
	surge_immunity: boolean,
	outage_immunity: boolean,
	is_datacenter: boolean,
	width: number,
	height: number,
	camera_entry: [number, number],
	all_possible_users: TniJsonUserId,
	scene: TniJsonLocationSceneItems[],
}

export interface TniJsonLocationPiece {
	scene: TniJsonLocationSceneItems[],
}

export type TniJsonLocationSceneItems
	= TniJsonLocationSceneItemRandomLocationPiece
	| TniJsonLocationSceneItemLCUOutlet
	| TniJsonLocationSceneItemPowerOutlet
	| TniJsonLocationSceneItemDeviceOutlet;

export interface TniJsonLocationSceneItemBase {
	type: string,
	position: [number, number],
}
export interface TniJsonLocationSceneItemRandomLocationPiece extends TniJsonLocationSceneItemBase {
	type: "LocationPiece",
	ids: TniJsonLocationPieceId[],
	refsize: [number, number],
	position: [number, number]
}
export interface TniJsonLocationSceneItemLCUOutlet extends TniJsonLocationSceneItemBase {
	type: "LCUOutlet",
	sockets: TniSocketType[],
	user: TniJsonUserId,
}
export interface TniJsonLocationSceneItemPowerOutlet extends TniJsonLocationSceneItemBase {
	type: "PowerOutlet",
	sockets: TniSocketType[],
	user: TniJsonUserId,
}
export interface TniJsonLocationSceneItemDeviceOutlet extends TniJsonLocationSceneItemBase {
	type: "DeviceOutlet",
	id: TniJsonDeviceOutletId,
}
